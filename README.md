...
As per the professor of the course, the scope of the original project is a bit large for the time range provided, so here are a few features that I hope to see by the end but cannot guarantee:
- Admin accounts that have both developer and customer permissions, as well as access to pages allowing them to view/manage all users, games, and orders.
- Implementing Gift cards and their usage in the payment process.
